...
if __name__ == '__main__':
    ...
    try:
        time.sleep(0.5)
        responce = requests.get(f'https://v01.ru/auto/search/0k55110602/?brand_title=DYG&extra%5Bwf_b%5D%5B0%5D=DYG+GASKETS&extra%5Bwf_b%5D%5B1%5D=DYG')
        print("\n\n", "----->", f'https://v01.ru/auto/search/0k55110602/?brand_title=DYG&extra%5Bwf_b%5D%5B0%5D=DYG+GASKETS&extra%5Bwf_b%5D%5B1%5D=DYG', '\n\n')
